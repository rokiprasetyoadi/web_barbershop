                  ...
                  <div class="module-content module-box cart-box">
                    <div class="cart-overview">
                      <ul class="list-unstyled">
                        <li>
                          <a href="#">
                            <img class="img-responsive" src="<?= base_url() ?>assets/web_profile/images/shop/thumb/1.jpg" alt="product" />
                          </a>
                        ...
                        <li>
                          <a href="#">
                            <img class="img-responsive" src="<?= base_url() ?>assets/web_profile/images/shop/thumb/2.jpg" alt="product" />
                          </a>
                          <div class="product-meta">
                        ...
                        <li>
                          <a href="#">
                            <img class="img-responsive" src="<?= base_url() ?>assets/web_profile/images/shop/thumb/3.jpg" alt="product" />
                          </a>
                          <div class="product-meta">
