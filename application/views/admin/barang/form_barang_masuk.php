        ...
        <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form class="cmxform form-horizontal " method="POST" enctype="multipart/form-data" action="<?php echo site_url('admin/barang_masuk/edit/'.$row->brgmasuk_nota); ?>">
                                    <div class="form-group ">
                                        <label for="brgmasuk_nota" class="control-label col-lg-3">Id Nota</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="brgmasuk_nota" name="brgmasuk_nota" type="text" value="<?= $kode; ?>" readonly />
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <select name="brgmasuk_supplier_id">
                                                ...
                                                <option value="<?= $row->brgmasuk_supplier_id; ?>"><?= $row->brgmasuk_supplier_id; ?></option>
