...
<div class="brand">
    ...
    <a href="index-2.html" class="logo">
        <img src="<?php echo base_url('assets/adm/images/logo1.png') ?>" alt="">
    </a>
    ...
    <ul class="nav top-menu">
        ...
        <li id="header_inbox_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="<?php echo base_url('assets/adm/images/avatar-mini.jpg') ?>"></span>
                                <span class="subject">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="<?php echo base_url('assets/adm/images/avatar-mini-2.jpg') ?>"></span>
                                <span class="subject">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="<?php echo base_url('assets/adm/images/avatar-mini-3.jpg') ?>"></span>
                                <span class="subject">
...
<div class="top-nav clearfix">
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img alt="" src="<?php echo base_url('assets/adm/images/avatar1_small.jpg') ?>">
                    ...
                    <ul class="conversation-list">
                        <li class="clearfix">
                            <div class="chat-avatar">
                                <img src="<?php echo base_url('assets/adm/images/chat-user-thumb.png') ?>" alt="male">
                                <i>10:00</i>
                            </div>
                        ...
                        <li class="clearfix odd">
                            <div class="chat-avatar">
                                <img src="<?php echo base_url('assets/adm/images/chat-user-thumb-f.png') ?>" alt="female">
                                <i>10:00</i>
                            </div>
                            <div class="conversation-text">
                                <div class="ctext-wrap">
...
<div class="row">
    <div class="col-md-8">
        <section class="panel">
            <div class="wdgt-row">
                <img src="<?php echo base_url('assets/adm/images/weather_image.jpg') ?>" height="243" alt="">
                <div class="wdt-head">
                    weather forecast
                </div>
        ...
        <li>
            <div class="prog-row">
                <div class="user-thumb">
                    <a href="#"><img src="<?php echo base_url('assets/adm/images/avatar1_small.jpg') ?>" alt=""></a>
                </div>
            ...
            <div class="prog-row">
                <div class="user-thumb">
                    <a href="#"><img src="<?php echo base_url('assets/adm/images/avatar1.jpg') ?>" alt=""></a>
                </div>
                <div class="user-details">
            ...
            <div class="prog-row">
                <div class="user-thumb">
                    <a href="#"><img src="<?php echo base_url('assets/adm/images/chat-avatar2.jpg') ?>" alt=""></a>
                </div>
                <div class="user-details">
