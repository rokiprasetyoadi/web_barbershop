...
<!--right sidebar end-->
    ...
    <script
        src="<?php echo base_url('assets/adm/cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.3/jquery.easing.min.js') ?>">
    </script>
    <script src="<?php echo base_url('assets/adm/js/calendar/clndr.js') ?>"></script>
    <script
        src="<?php echo base_url('assets/adm/cdnjs.cloudflare.com/ajax/libs/underscore.js/1.5.2/underscore-min.js') ?>">
    </script>
